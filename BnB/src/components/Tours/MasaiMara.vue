<template>
  <div class="p-6">
     <p class="text-gray-500 pb-6 text-sm">
      Experience the thrill of a lifetime with our exclusive Masai Mara safari tour. Witness the majestic wildlife, breathtaking landscapes, and immerse yourself in the rich culture of the Maasai people. Book your adventure today!
    </p>
    <form action="" class="">
      <div class="flex flex-wrap gap-10 items-center mb-4">
        <div class="flex flex-col mb-4">
          <label for="text" class="text-gray-600">Date</label>
          <input
            type="date"
            id="text"
            name="text"
        ...
        <div class="flex flex-col mb-4">
          <label for="text" class="text-gray-600">Pick-Ups</label>
          <input
            type="text"
            id="text"
            name="text"
